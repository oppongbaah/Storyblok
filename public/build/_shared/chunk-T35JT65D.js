...
var _EventHelpers = class {
  constructor(storage) {
    ...
    this.getCurrentLocale = (event) => {
      return this.browserStorage.getValue(ConstantsFactory.locale);
    };
    this.browserStorage = storage;
  }
  setCurrentLocale(value) {
    this.browserStorage.setValue(_EventHelpers.LOCALE, value);
  }
...
var EventHelpers = _EventHelpers;
EventHelpers.LOCALE = ConstantsFactory.locale;
...
//# sourceMappingURL=/build/_shared/chunk-T35JT65D.js.map
